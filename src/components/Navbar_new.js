                ...
                <div className="flex items-center justify-between py-4">
                    ...
                    >
                        <Link href="/" className="flex items-center space-x-3">
                            <div className="w-10 h-10 bg-gradient-to-br from-primary-600 to-primary-700 rounded-xl flex items-center justify-center shadow-elegant">
                                <span className="text-white font-bold text-lg">C</span>
                            </div>
                            <div className="flex flex-col">
                                <span className={`font-display font-bold text-xl ${isScrolled ? "text-neutral-900" : "text-white"}`}>
                                    CraftChain
                                </span>
                                <span className={`text-xs font-medium ${isScrolled ? "text-neutral-600" : "text-white/80"}`}>
                                    Authentic • Verified • Fair
                                </span>
                            </div>
                        </Link>
                    </motion.div>
